...
START TRANSACTION;
USE `eternitygamehubdb`;
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (1, 'Super Mario Bros.', 'Players control Mario, or his brother Luigi in the multiplayer mode, as they travel the Mushroom Kingdom to rescue Princess Toadstool from Bowser (King Koopa). They traverse side-scrolling stages while avoiding hazards such as enemies and pits with the aid of power-ups such as the Super Mushroom, Fire Flower and Starman.', 2, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (2, 'The Legend of Zelda', 'Set in the fantasy land of Hyrule, the plot centers on an elf-like boy named Link, who aims to collect the eight fragments of the Triforce of Wisdom in order to rescue Princess Zelda from the antagonist, Ganon.', 1, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (3, 'Mike Tyson\'s Punch-Out!', 'Punch-Out!! features a boxer known as Little Mac, fighting his way up through ranks of the World Video Boxing Association.', 1, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (4, 'Mega Man 2', 'Mega Man 2 is a platform and action game like its predecessor, Mega Man. The player controls Mega Man as he traverses eight stages to defeat the bosses, Dr. Wily\'s Robot Masters: Metal Man, Air Man, Bubble Man, Quick Man, Crash Man, Flash Man, Heat Man, and Wood Man.', 1, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (5, 'Ninja Gaiden', 'Ninja Gaiden features a ninja named Ryu Hayabusa who seeks revenge for the death of his father and gradually finds himself involved in a sinister plot that threatens the entire world.', 1, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (6, 'Super Mario Bros. 3', 'Super Mario Bros. 3 is a two-dimensional, side-scrolling platform game in which the player controls either Mario or Luigi. The game shares similar gameplay mechanics with previous games in the series.', 2, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (7, 'Prince of Persia', 'The game is set in medieval Persia. While the sultan is fighting a war in a foreign land, his vizier Jaffar, a wizard, seizes power. His only obstacle to the throne is the Sultan\'s daughter. Jaffar locks her in a tower and orders her to become his wife, or she would die within 60 minutes.', 1, 1, 1, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (8, 'SimCity', 'The objective of SimCity is to build and design a city, without specific goals to achieve.', 1, 1, 2, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (9, 'The Secret of Monkey Island', 'The Secret of Monkey Island is a 2D adventure game played from a third-person perspective. Via a point-and-click interface, the player guides protagonist Guybrush Threepwood through the game\'s world and interacts with the environment by selecting from twelve verb commands (nine in newer versions) such as \"talk to\" for communicating with characters and \"pick up\" for collecting items between commands and the world\'s objects in order to successfully solve puzzles and thus progress in the game.', 1, 1, 2, 'https://i.imgur.com/a3H171W.png');
INSERT INTO `game` (`id`, `title`, `description`, `max_players`, `user_id`, `rating_id`, `image_url`) VALUES (10, 'Super Mario World', 'Super Mario World is a side-scrolling platform game in which the player controls Mario or Luigi, the protagonists of the game. The game has similar gameplay to earlier games in the Super Mario series.', 2, 1, 1, 'https://i.imgur.com/a3H171W.png');
...
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (2, 2, 11, 2, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-22', '2021-12-22');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (3, 3, 11, 3, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-23', '2021-12-22');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (4, 4, 11, 4, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-24', '2021-12-23');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (5, 4, 12, 5, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-25', '2021-12-24');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (6, 4, 12, 6, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-26', '2021-12-26');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (7, 5, 12, 7, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-22', '2021-12-22');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (8, 6, 13, 8, '2021-12-13 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-27', '2021-12-27');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (9, 6, 14, 9, '2021-12-15 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-28', '2021-12-28');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (10, 6, 14, 10, '2021-12-16 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-27', '2021-12-27');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (11, 7, 14, 11, '2021-12-17 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-28', '2021-12-28');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (12, 8, 15, 12, '2021-12-18 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-22', '2021-12-22');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (13, 9, 16, 13, '2021-12-19 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-23', '2021-12-23');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (14, 9, 17, 14, '2021-12-20 3:33:30', 5, 'Arrived in perfect condition', 5, 'Nice person', '2021-12-24', '2021-12-24');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (15, 9, 17, 15, '2021-12-21 3:33:30', 4, 'Seller was good, game was ok', 4, 'Good person', '2021-12-25', '2021-12-25');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (16, 10, 17, 16, '2021-12-22 3:33:30', 3, 'Condition not as listed', 3, 'Ok person', '2021-12-26', '2021-12-26');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (17, 10, 18, 17, '2021-12-23 3:33:30', 2, 'Terrible communication', 2, 'Bad person', '2021-12-27', '2021-12-27');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (18, 10, 18, 18, '2021-12-24 3:33:30', 1, 'Just awful', 1, 'Terrible person', '2021-12-28', '2021-12-28');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (19, 19, 11, 19, '2021-12-25 3:33:30', 4, 'Seller was good, game was ok', 3, 'Good person', '2021-12-28', '2021-12-28');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (20, 19, 12, 20, '2021-12-26 3:33:30', 4, 'Seller was good, game was ok', 3, 'Good person', '2022-1-5', '2021-12-29');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (21, 19, 13, 21, '2021-12-27 3:33:30', 4, 'Seller was good, game was ok', 5, 'Good person', '2022-1-6', '2021-12-30');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (22, 19, 14, 22, '2021-12-28 3:33:30', 3, 'Seller was good, game was ok', 4, 'Good person', '2022-1-7', '2021-12-31');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (23, 20, 15, 23, '2021-12-29 3:33:30', 3, 'Seller was good, game was ok', 5, 'Good person', '2022-1-8', '2022-1-1');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (24, 20, 15, 24, '2021-12-30 3:33:30', 3, 'Seller was good, game was ok', 4, 'Good person', '2022-1-9', '2022-1-2');
INSERT INTO `sale` (`id`, `buyer_id`, `seller_id`, `game_inventory_id`, `sale_date`, `rating_by_buyer`, `comment_by_buyer`, `rating_by_seller`, `comment_by_seller`, `return_by_date`, `date_returned`) VALUES (25, 20, 16, 25, '2021-12-31 3:33:30', 4, 'Seller was good, game was ok', 2, 'Good person', '2022-1-10', '2022-1-3');
